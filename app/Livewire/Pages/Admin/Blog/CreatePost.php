...
#[Layout('layouts.app')]
class CreatePost extends Component implements HasSchemas, HasActions
{
                    ...
                    ->schema([
                        ...
                        Actions::make([
                            ...
                            Action::make('cancel')
                                ->label('Batal')
                                ->color('secondary')
                                ->action(fn() => $this->redirectRoute('tulisan.index')),
                        ]),
                    ])
            ])
            ->statePath('data');
    ...
    {
        return view('livewire.pages.admin.blog.create-post');
    }
}
